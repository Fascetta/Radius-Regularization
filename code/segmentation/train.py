...
def main(cfg):
    ...
    fabric.print("-----------------\nTraining finished\n-----------------")
    fabric.print("Best epoch = {}, with mIoU={:.4f}".format(best_epoch, best_mIoU))
    ...
    loss_test, mIoU_test, cm = evaluate(
        model,
        test_loader,
        criterion,
        device,
    ...
    fabric.print("Results: Loss={:.4f}, mIoU={:.4f}".format(loss_test, mIoU_test))
...
def evaluate(
    ...
    return losses.avg, mIoU.avg, calib_metrics
